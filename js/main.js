...
(function($){
  ...
  // Trigger initial scrollspy check on page load
  setTimeout(function() {
    $(window).trigger('scroll');
  }, 100);
  
  $(window).scroll(function(e){
    // scrollTop retains the value of the scroll top with the reference at the 1/3 point of the page
    ...
    // Always trigger the event to update submenu display
